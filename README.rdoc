...
install the gem using the .gem file in github ( will be making it live on github later so you can just do a sudo jgem install m2-helper)

sudo jgem install m2-helper-0.0.1.gem
